...
public class RefValTypeSolver {
    private final SlotManager slotManager;
    private final String datatype;
    private final RefValSerializer serializer;
    private final List<VecInt> clauses;

    public RefValTypeSolver(String datatype, Collection<Constraint> constraints, RefValSerializer serializer) {
    ...
    public RefValTypeSolution solve() {
            ...
            if (hasSolution) {
                ...
                for (Integer var : solution) {
                    ...
                    if (potential != null) {
                        ...
                        // inferred.
                        // For refval, that means that the annotation should
                        // have the type.
                        result.put(var, !varIsTrue);
                    }
                }
                // System.out.println("*******************************");
                return new RefValTypeSolution(result, datatype, this.serializer.isRoot());
            }
        ...
        return RefValTypeSolution.noSolution(datatype);
    }
}
