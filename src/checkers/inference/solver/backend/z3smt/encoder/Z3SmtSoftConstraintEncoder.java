...
public abstract class Z3SmtSoftConstraintEncoder<SlotEncodingT, SlotSolutionT> {
     ...
     * AbstractConstraintEncoder} might need. For example, {@link checkers.inference.solver.backend.z3.encoder.Z3SmtSubtypeConstraintEncoder}
     * needs it to format translate {@SubtypeConstraint}. {@link checkers.inference.solver.backend.maxsat.encoder.MaxSATImplicationConstraintEncoder}
